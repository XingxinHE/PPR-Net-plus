...
# output dirs
OUT_ROOT_DIR = '/workspace/PPR-Net-plus/dataset/bunny_h5'
...
# input dirs
IN_ROOT_DIR = '/workspace/PPR-Net-plus/dataset/SileaneBunny_part_1'
...
if __name__ == "__main__":
    cycle_idx_list = range(230, 250)  #HERE
    scene_idx_list = range(3, 81)  #HERE
